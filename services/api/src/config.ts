...
export const config = {
  ...
  // WhatsApp Business
  WHATSAPP_PROVIDER: optional('WHATSAPP_PROVIDER', 'msg91'),
  MSG91_WHATSAPP_TOKEN: optional('MSG91_WHATSAPP_TOKEN'),
  MSG91_WHATSAPP_SENDER: optional('MSG91_WHATSAPP_SENDER', '918888888888'),
  INTERAKT_API_KEY: optional('INTERAKT_API_KEY'),
  ...
  // Gemini AI — REMOVED, replaced by Groq
  // GEMINI_API_KEY: optional('GEMINI_API_KEY'),

  // Groq AI (Uniform check + Face match + Text analysis)
  ...
  CASHFREE_ENV: optional('CASHFREE_ENV', 'TEST'), // TEST | PROD

  // Google Maps
  GOOGLE_MAPS_API_KEY: optional('GOOGLE_MAPS_API_KEY'),

  // AI
  // Roboflow — REMOVED, replaced by Groq AI
  // ROBOFLOW_API_KEY:  optional('ROBOFLOW_API_KEY'),
  // ROBOFLOW_MODEL_ID: optional('ROBOFLOW_MODEL_ID'),
